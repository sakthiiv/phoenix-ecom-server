...
public class CategoryControllerTest extends AbstractTest{
   ...
   /* @Test
    ...
    public void shouldCreateACategory() throws Exception {
        ...
        this.mvc.perform(post("/category").contentType(MediaType.APPLICATION_JSON).content(inputJson)).andDo(print()).andExpect(status().isCreated())
    ...
    public void shouldReturnInternalServerError() throws Exception {
        ...
        this.mvc.perform(post("/category").contentType(MediaType.APPLICATION_JSON).content(inputJson)).andDo(print()).andExpect(status().is5xxServerError())
